...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1,AFDRV_BU63165AF, BU63165AF_SetI2Cclient, BU63165AF_Ioctl,
...
#endif
#ifdef CONFIG_MTK_LENS_FP5510E2AF_SUPPORT
	...
	if (Stage == 0) {
		if (regVCAMAF == NULL) {
			...
			if (node) {
				...
				#if defined(CONFIG_MACH_MT6765) || defined(CONFIG_MACH_MT6771) || defined(CONFIG_MACH_MT6739)
				regVCAMAF =
