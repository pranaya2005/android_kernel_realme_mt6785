...
#define LCM_PHYSICAL_WIDTH (62884)
#define LCM_PHYSICAL_HEIGHT (124768)
...
#define GPIO_LCM_ENP_1         (GPIO107 | 0x80000000)
#define GPIO_LCM_ENN_1         (GPIO108 | 0x80000000)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
struct LCM_DRIVER r61350_cpt55_xinli_lhd_lcm_drv = 
{
  .name          = "r61350_cpt55_xinli_lhd",
