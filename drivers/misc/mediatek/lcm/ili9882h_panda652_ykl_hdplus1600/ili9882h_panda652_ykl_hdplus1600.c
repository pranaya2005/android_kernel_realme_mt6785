...
#if defined(BUILD_LK)
	printf("%s,ili9882h_panda652_ykl_hdplus1600 id = 0x%08x\n", __func__, id);
#else
	printk("%s,ili9882h_panda652_ykl_hdplus1600 id = 0x%08x\n", __func__, id);
#endif
	return (id == 0x82 )?1:0;
}

struct LCM_DRIVER ili9882h_panda652_ykl_hdplus1600_lcm_drv = {
	.name 				= "ili9882h_panda652_ykl_hdplus1600",
