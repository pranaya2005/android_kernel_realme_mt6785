...
#ifdef BUILD_LK
	printf("ft8719_auo630_xl_fhdpp2340_lcm_drv:lcm_id = 0x%x\n", lcm_id);
#else
	printk("ft8719_auo630_xl_fhdpp2340_lcm_drv:lcm_id = 0x%x\n", lcm_id);
#endif

	return ((lcm_id == LCM_ID_FT8719) ? 1 : 0);
}

struct LCM_DRIVER ft8719_auo630_xl_fhdpp2340_lcm_drv = {
	.name = "ft8719_auo630_xl_fhdpp2340_lcm_drv",
