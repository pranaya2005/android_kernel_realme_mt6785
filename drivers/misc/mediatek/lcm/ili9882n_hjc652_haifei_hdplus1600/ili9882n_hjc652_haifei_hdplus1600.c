...
static struct LCM_setting_table lcm_init_setting[] = {
  {0xFF,3,{0x98,0x82,0x01}},
	...
	{0x08,1,{0x80}},  
	{0x09,1,{0x0A}},  //DUMMT CK 12
	{0x0a,1,{0x71}},
	{0x0b,1,{0x00}},  //clk keep 10 off 00  10
	{0x0d,1,{0x00}},  //01
	{0x0e,1,{0x01}},  //10
	{0x0f,1,{0x01}},   //10
	...
	//{0xCD,1,{0x00}},    //调整CLK8跟TSHD的时间时删掉  0702
  ...
  {0xE0,27,{0x00,0x24,0x7A,0xB0,0xF1,0x55,0x24,0x4B,0x78,0x9B,0xA5,0xD2,0xFD,0x24,0x49,0xAA,0x70,0xA2,0xC2,0xEB,0xFF,0x0E,0x3A,0x71,0x9E,0x03,0xEC}},
  {0xE1,27,{0x00,0x24,0x7A,0xB0,0xF1,0x55,0x24,0x4B,0x78,0x9B,0xA5,0xD2,0xFD,0x24,0x49,0xAA,0x70,0xA2,0xC2,0xEB,0xFF,0x0E,0x3A,0x71,0x9E,0x03,0xEC}},
...
#if defined(BUILD_LK)
	printf("%s,ili9882n_hjc652_haifei_hdplus1600 id = 0x%08x\n", __func__, id);
#else
	printk("%s,ili9882n_hjc652_haifei_hdplus1600 id = 0x%08x\n", __func__, id);
#endif
	return (id == 0x82 )?1:0;
}

struct LCM_DRIVER ili9882n_hjc652_haifei_hdplus1600_lcm_drv = {
	.name 				= "ili9882n_hjc652_haifei_hdplus1600",
