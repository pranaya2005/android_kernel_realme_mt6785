...
static int dummy_pinctrl_init(struct platform_device *pdev)
{
    ...
    if (IS_ERR(flashlight_hwen_high)) {
        ...
        printk("%s : init err, flashlight_hwen_high\n", __func__);
    }
    ...
    if (IS_ERR(flashlight_hwen_low)) {
        ...
        printk("%s : init err, flashlight_hwen_low\n", __func__);
    }
    ...
    if (IS_ERR(flashlight_torch_high)) {
        ...
        printk("%s : init err, flashlight_torch_high\n", __func__);
    }
    ...
    if (IS_ERR(flashlight_torch_low)) {
        ...
        printk("%s : init err, flashlight_torch_low\n", __func__);
    }
    ...
    if (IS_ERR(flashlight_flash_high)) {
        ...
        printk("%s : init err, flashlight_flash_high\n", __func__);
    }
    ...
    if (IS_ERR(flashlight_flash_low)) {
        ...
        printk("%s : init err, flashlight_flash_low\n", __func__);
    }
    ...
    if (IS_ERR(sub_flashlight_flash_high)) {
        ...
        printk("%s : init err, sub_flashlight_flash_high\n", __func__);
    }
    ...
    if (IS_ERR(sub_flashlight_flash_low)) {
        ...
        printk("%s : init err, sub_flashlight_flash_low\n", __func__);
    }
...
int flashlight_gpio_set(int pin , int state)
{
    ...
    if (IS_ERR(flashlight_pinctrl)) {
        printk("%s : set err, flashlight_pinctrl not available\n", __func__);
        return -1;
    }
    ...
    case FLASHLIGHT_PIN_HWEN:
        if (state == STATE_LOW && !IS_ERR(flashlight_hwen_low))
            ...
            printk("%s : set err, pin(%d) state(%d)\n", __func__, pin, state);
        break;
