...
YUV_SENSOR yuvSensorList[] = {
...
#if defined(GC030A_MIPI_YUV)
  {GC030A_YUV_ID,GC030A_YUV_NAME,GC030A_YUV_SENSOR_INIT},
#endif
...
#if defined(SP0A08_MIPI_YUV)
  {SP0A08_YUV_ID,SP0A08_YUV_NAME,SP0A08_YUV_SENSOR_INIT},
#endif
  ...
  {GC032A_YUV_ID,GC032A_YUV_NAME,GC032A_YUV_SENSOR_INIT},
#endif
