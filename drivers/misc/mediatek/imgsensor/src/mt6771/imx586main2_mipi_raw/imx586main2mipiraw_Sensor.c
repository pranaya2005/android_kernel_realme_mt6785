...
static kal_uint32 imx586main2_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
UINT32 IMX586MAIN2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
