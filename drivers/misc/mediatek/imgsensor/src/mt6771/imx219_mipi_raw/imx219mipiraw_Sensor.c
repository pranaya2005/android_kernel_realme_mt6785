...
#define REG_INIT(addr,data)    ((addr) >>8) & 0xFF,((addr) >>0) & 0xFF,   \
									(data & 0xFF)
...
#define MAX_TRANSFER_LENGTH   255
#define TRANSACTION_LENGTH    3
static kal_uint16 DMA_Write_Reg(void * PBuf,kal_uint32 Len)
{
  ...
  if (PTemp == NULL)
  {
	 LOG_INF("DMA_Write_Reg input buffer is empty\n"); 
	 return 0;
  }
 // kdSetI2CSpeed(imgsensor_info.i2c_speed);
  for(;;)
  {
	  ...
	  {
		   iBurstWriteReg_multi(PTemp,Len,imgsensor.i2c_write_id,TRANSACTION_LENGTH,400);
		   break;
	  }
      else
	  {
		  iBurstWriteReg_multi(PTemp,MAX_TRANSFER_LENGTH,imgsensor.i2c_write_id,TRANSACTION_LENGTH,400);
...
static unsigned char Preview_Setting_Addr_Data_Pair[]=
{
	REG_INIT(0x0100,  0x00),
	REG_INIT(0x30EB,  0x05),	
	REG_INIT(0x30EB,  0x0C),	
	REG_INIT(0x300A,  0xFF),	
	REG_INIT(0x300B,  0xFF),	
	REG_INIT(0x30EB,  0x05),	
	REG_INIT(0x30EB,  0x09),		  
	REG_INIT(0x0114,  0x03),	
	REG_INIT(0x0128,  0x00),	
	REG_INIT(0x012A,  0x18),	
	REG_INIT(0x012B,  0x00),	
	REG_INIT(0x0160,  0x05),   
	REG_INIT(0x0161,  0x34),	
	REG_INIT(0x0162,  0x0D),	 
	REG_INIT(0x0163,  0x78), 
	REG_INIT(0x0164,  0x00),	
	REG_INIT(0x0165,  0x00),
	REG_INIT(0x0166,  0x0C),	
	REG_INIT(0x0167,  0xCF),	
	REG_INIT(0x0168,  0x00),	
	REG_INIT(0x0169,  0x00),	
	REG_INIT(0x016A,  0x09),	
	REG_INIT(0x016B,  0x9F),	
	REG_INIT(0x016C,  0x06),	
	REG_INIT(0x016D,  0x68),	
	REG_INIT(0x016E,  0x04),	
	REG_INIT(0x016F,  0xD0),	
	REG_INIT(0x0170,  0x01),	
	REG_INIT(0x0171,  0x01),	
	REG_INIT(0x0174,  0x01),	
	REG_INIT(0x0175,  0x01),	
	REG_INIT(0x018C,  0x0A),	
	REG_INIT(0x018D,  0x0A),	
	REG_INIT(0x0301,  0x05),	
	REG_INIT(0x0303,  0x01),	
	REG_INIT(0x0304,  0x03),	
	REG_INIT(0x0305,  0x03),	
	REG_INIT(0x0306,  0x00),	
	REG_INIT(0x0307,  0x2B),	
	REG_INIT(0x0309,  0x0A),	
	REG_INIT(0x030B,  0x01),	
	REG_INIT(0x030C,  0x00),	
	REG_INIT(0x030D,  0x2E),	
	REG_INIT(0x455E,  0x00),	
	REG_INIT(0x471E,  0x4B),	
	REG_INIT(0x4767,  0x0F),	
	REG_INIT(0x4750,  0x14),	
	REG_INIT(0x4540,  0x00),	
	REG_INIT(0x47B4,  0x14),	
	REG_INIT(0x4713,  0x30),	
	REG_INIT(0x478B,  0x10),	
	REG_INIT(0x478F,  0x10),	
	REG_INIT(0x4793,  0x10),	
	REG_INIT(0x4797,  0x0E),	
	REG_INIT(0x479B,  0x0E),	
	REG_INIT(0x0100,  0x01)  
};
...
#endif
#if 1
 	//LOG_INF("sizeof(Preview_Setting_Addr_Data_Pair)=%d\n",sizeof(Preview_Setting_Addr_Data_Pair));
 	DMA_Write_Reg(Preview_Setting_Addr_Data_Pair,sizeof(Preview_Setting_Addr_Data_Pair));
#endif
	LOG_INF("E-\n");
}	/*	preview_setting  */
static unsigned char capture_Setting_normal_Addr_Data_Pair[]=
{	//30fps 		//30fps for Normal capture & ZSD
	...
	REG_INIT(0x012A,   0x18), 
	REG_INIT(0x012B,   0x00), 
	REG_INIT(0x0160,   0x09), 
	REG_INIT(0x0161,   0xF0),
	REG_INIT(0x0162,   0X0D),	
	REG_INIT(0x0163,   0X78),
	REG_INIT(0x0164,   0x00), 
	REG_INIT(0x0165,   0x00), 
	...
	REG_INIT(0x016A,   0x09), 
	REG_INIT(0x016B,   0x9F), 
	REG_INIT(0x016C,   0x0C), 
	REG_INIT(0x016D,   0xD0), 
	REG_INIT(0x016E,   0x09), 
	REG_INIT(0x016F,   0xA0), 
	REG_INIT(0x0170,   0x01), 
	REG_INIT(0x0171,   0x01), 
	REG_INIT(0x0174,   0x00), 
	REG_INIT(0x0175,   0x00), 
	REG_INIT(0x018C,   0x0A), 
	REG_INIT(0x018D,   0x0A), 
	REG_INIT(0x0301,   0x05), 
	REG_INIT(0x0303,   0x01), 
	...
	REG_INIT(0x0305,   0x03), 
	REG_INIT(0x0306,   0x00), 
	REG_INIT(0x0307,   0x53), //0x51
	REG_INIT(0x0309,   0x0A), 
	REG_INIT(0x030B,   0x01), 
	REG_INIT(0x030C,   0x00), 
	REG_INIT(0x030D,   0x56),//0x54 
	REG_INIT(0x455E,   0x00), 
	REG_INIT(0x471E,   0x4B), 
	REG_INIT(0x4767,   0x0F), 
	REG_INIT(0x4750,   0x14), 
...
static unsigned char capture_Setting_pip_Addr_Data_Pair[]=
{
	REG_INIT(0x0100,   0x00), 																																							
	REG_INIT(0x30EB,   0x05), 																																							
	REG_INIT(0x30EB,   0x0C), 																																							
	...
	REG_INIT(0x0305,   0x03), 																																																				
	REG_INIT(0x0306,   0x00), 																																																				
	REG_INIT(0x0307,   0x53), 																																																				
	REG_INIT(0x0309,   0x0A), 																																																				
	REG_INIT(0x030B,   0x01), 																																																				
	REG_INIT(0x030C,   0x00), 																																																				
	REG_INIT(0x030D,   0x56),																																																				 
	REG_INIT(0x455E,   0x00), 																																																				
	REG_INIT(0x471E,   0x4B), 																																																																	
	REG_INIT(0x4767,   0x0F), 																																																																	
	REG_INIT(0x4750,   0x14), 																																																																	
...
static void capture_setting(kal_uint16 currefps)
{
	...
	{
		#if 1
 		//LOG_INF("sizeof(capture_Setting_pip_Addr_Data_Pair)=%d\n",sizeof(capture_Setting_pip_Addr_Data_Pair));
 		DMA_Write_Reg(capture_Setting_pip_Addr_Data_Pair,sizeof(capture_Setting_pip_Addr_Data_Pair));
		#endif
	}
    else
	{
		#if 1
 		//LOG_INF("sizeof(capture_Setting_normal_Addr_Data_Pair)=%d\n",sizeof(capture_Setting_normal_Addr_Data_Pair));
 		DMA_Write_Reg(capture_Setting_normal_Addr_Data_Pair,sizeof(capture_Setting_normal_Addr_Data_Pair));
		#endif
	}	
...
static unsigned char normal_video_setting_Addr_Data_Pair[]=
{
	REG_INIT(0x0100,	 0x00), 
	REG_INIT(0x30EB,   0x05), 
	REG_INIT(0x30EB,   0x0C), 
...
{ 
	LOG_INF("E! currefps:%d\n",currefps);
	#if 1
 		//LOG_INF("sizeof(normal_video_setting_Addr_Data_Pair)=%d\n",sizeof(normal_video_setting_Addr_Data_Pair));
 		DMA_Write_Reg(normal_video_setting_Addr_Data_Pair,sizeof(normal_video_setting_Addr_Data_Pair));
	#endif
	#if 0
	write_cmos_sensor(0x0100,	  0x00); 
	write_cmos_sensor(0x30EB,   0x05); 
...
static unsigned char hs_video_setting_Addr_Data_Pair[]=
{
	REG_INIT(0x0100,	0x00), 
	REG_INIT(0x30EB,	0x05), 
	REG_INIT(0x30EB,	0x0C), 
	...
	REG_INIT(0x012A,	0x18), 
	REG_INIT(0x012B,	0x00), 
	REG_INIT(0x0160,	0x02), 
	REG_INIT(0x0161,	0xA1),
	REG_INIT(0x0162,	0x0D),	
	REG_INIT(0x0163,	0x78),
	REG_INIT(0x0164,	0x01), 
	REG_INIT(0x0165,	0x68), 
	REG_INIT(0x0166,	0x0B), 
	REG_INIT(0x0167,	0x67), 
	REG_INIT(0x0168,	0x01), 
	REG_INIT(0x0169,	0x10), 
	REG_INIT(0x016A,	0x08), 
	REG_INIT(0x016B,	0x8F), 
	REG_INIT(0x016C,	0x02), 
	REG_INIT(0x016D,	0x80), 
	REG_INIT(0x016E,	0x01), 
	REG_INIT(0x016F,	0xE0), 
	REG_INIT(0x0170,	0x01), 
	REG_INIT(0x0171,	0x01), 
	REG_INIT(0x0174,	0x02), 
	REG_INIT(0x0175,	0x02), 
	REG_INIT(0x018C,	0x0A), 
	REG_INIT(0x018D,	0x0A), 
	REG_INIT(0x0301,	0x05), 
	REG_INIT(0x0303,	0x01), 
	...
	REG_INIT(0x0305,	0x03), 
	REG_INIT(0x0306,	0x00), 
	REG_INIT(0x0307,	0x57), //0x51
	REG_INIT(0x0309,	0x0A), 
	REG_INIT(0x030B,	0x01), 
	REG_INIT(0x030C,	0x00), 
	REG_INIT(0x030D,	0x5A),//0x54 
	REG_INIT(0x455E,	0x00), 
	REG_INIT(0x471E,	0x4B), 
	REG_INIT(0x4767,	0x0F), 
	REG_INIT(0x4750,	0x14), 
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	#if 1
 		//LOG_INF("sizeof(hs_video_setting_Addr_Data_Pair)=%d\n",sizeof(hs_video_setting_Addr_Data_Pair));
 		DMA_Write_Reg(hs_video_setting_Addr_Data_Pair,sizeof(hs_video_setting_Addr_Data_Pair));
	#endif
	#if 0
	write_cmos_sensor(0x0100,	0x00); 
	write_cmos_sensor(0x30EB,	0x05); 
...
static unsigned char slim_video_setting_Addr_Data_Pair[]=
{
	REG_INIT(0x0100,   0x00), 
	REG_INIT(0x30EB,   0x05), 
	REG_INIT(0x30EB,   0x0C), 
	...
	REG_INIT(0x0167,   0xCF), 
	REG_INIT(0x0168,   0x01), 
	REG_INIT(0x0169,   0x32), 
	REG_INIT(0x016A,   0x08), 
	REG_INIT(0x016B,   0x6D), 
	REG_INIT(0x016C,   0x06), 
	REG_INIT(0x016D,   0x68), 
	REG_INIT(0x016E,   0x03), 
	REG_INIT(0x016F,   0x9E), 
	REG_INIT(0x0170,   0x01), 
	REG_INIT(0x0171,   0x01), 
	REG_INIT(0x0174,   0x01), 
	REG_INIT(0x0175,   0x01), 
	...
	REG_INIT(0x0305,   0x03), 
	REG_INIT(0x0306,   0x00), 
	REG_INIT(0x0307,   0x2B), //0x51
	REG_INIT(0x0309,   0x0A), 
	REG_INIT(0x030B,   0x01), 
	REG_INIT(0x030C,   0x00), 
	REG_INIT(0x030D,   0x2E),//0x54 
	REG_INIT(0x455E,   0x00), 
	REG_INIT(0x471E,   0x4B), 
	REG_INIT(0x4767,   0x0F), 
	REG_INIT(0x4750,   0x14), 
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	#if 1
 		//LOG_INF("sizeof(slim_video_setting_Addr_Data_Pair)=%d\n",sizeof(slim_video_setting_Addr_Data_Pair));
 		DMA_Write_Reg(slim_video_setting_Addr_Data_Pair,sizeof(slim_video_setting_Addr_Data_Pair));
	#endif
	#if 0
	write_cmos_sensor(0x0100,   0x00); 
	write_cmos_sensor(0x30EB,   0x05); 
