...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	...
	{
		SENSOR_DRVNAME_S5K3T1SP_MIPI_RAW,
		{
...
#endif
#if defined(IMX586MAIN2_MIPI_RAW)
	{
		SENSOR_DRVNAME_IMX586MAIN2_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{AVDD, Vol_2800, 1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(S5K3P3SUB_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P3SUB_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(OV16880FCJ_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV16880FCJ_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#endif
#if defined(OV16880JC_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV16880JC_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#endif
#if defined(HSM_MIPI_RAW)
	{
		SENSOR_DRVNAME_HSM_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{AVDD, Vol_2800, 5},
			{DOVDD, Vol_1800, 5},
...
#endif
#if defined(OV16880SYX_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV16880SYX_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
