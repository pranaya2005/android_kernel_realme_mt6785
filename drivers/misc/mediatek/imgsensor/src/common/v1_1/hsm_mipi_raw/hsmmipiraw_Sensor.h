...
#define IMAGE_SENSOR_DRVNAME SENSOR_DRVNAME_HSM_MIPI_RAW
...
//------------------------Engineer mode---------------------------------
typedef struct {
	struct SENSOR_REG_STRUCT Reg[ENGINEER_END];
	struct SENSOR_REG_STRUCT CCT[FACTORY_END_ADDR];
...
{
	struct SENSOR_REG_STRUCT reg[MT9P015_ENGINEER_END];
	struct SENSOR_REG_STRUCT cct[MT9P015_FACTORY_END_ADDR];
} sensor_data_struct;
 */
...
//#define HSM_VIDEO_NORMALMODE_FRAME_RATE			30		// Limitation for MPEG4 Encode Only
//#define HSM_VIDEO_NIGHTMODE_FRAME_RATE			15
...
//#define HSM_SENSOR_NIGHT_MODE_GAIN				0x08	// Please refer to OV7670 Implementation Guide
...
#define HSM_SENSOR_GRAB_START_X			0
#define HSM_SENSOR_GRAB_START_Y			0

#define N6700_IMAGE_SENSOR_WIDTH		       (1280)
#define N6700_IMAGE_SENSOR_HEIGHT		       (800)

#define N6700_SENSOR_FULL_WIDTH		       ((N6700_IMAGE_SENSOR_WIDTH))
#define N6700_SENSOR_FULL_HEIGHT		       (N6700_IMAGE_SENSOR_HEIGHT)

#define N6700_SENSOR_PV_WIDTH                        ((N6700_IMAGE_SENSOR_WIDTH))
#define N6700_SENSOR_PV_HEIGHT                       (N6700_IMAGE_SENSOR_HEIGHT)

#define N6700_SENSOR_VIDEO_WIDTH                  ((N6700_IMAGE_SENSOR_WIDTH))
#define N6700_SENSOR_VIDEO_HEIGHT                 (N6700_IMAGE_SENSOR_HEIGHT)


#define N6700_WRITE_ID						(0x30)     // 8bit i2c write addr
#define N6700_READ_ID						(0x31)     // 8bit i2c read addr



#define N5600_IMAGE_SENSOR_WIDTH		       (832)
#define N5600_IMAGE_SENSOR_HEIGHT		       (640)

#define N5600_SENSOR_FULL_WIDTH		       ((N5600_IMAGE_SENSOR_WIDTH))
#define N5600_SENSOR_FULL_HEIGHT		       (N5600_IMAGE_SENSOR_HEIGHT)

#define N5600_SENSOR_PV_WIDTH                        ((N5600_IMAGE_SENSOR_WIDTH))
#define N5600_SENSOR_PV_HEIGHT                       (N5600_IMAGE_SENSOR_HEIGHT)

#define N5600_SENSOR_VIDEO_WIDTH                  ((N5600_IMAGE_SENSOR_WIDTH))
#define N5600_SENSOR_VIDEO_HEIGHT                 (N5600_IMAGE_SENSOR_HEIGHT)


#define N5600_WRITE_ID						(0x30)     // 8bit i2c write addr
#define N5600_READ_ID						(0x31)     // 8bit i2c read addr


#define N3600_IMAGE_SENSOR_WIDTH		       (1280)
#define N3600_IMAGE_SENSOR_HEIGHT		       (800)

#define N3600_SENSOR_FULL_WIDTH		       ((N3600_IMAGE_SENSOR_WIDTH << 1))
#define N3600_SENSOR_FULL_HEIGHT		       (N3600_IMAGE_SENSOR_HEIGHT)

#define N3600_SENSOR_PV_WIDTH                        ((N3600_IMAGE_SENSOR_WIDTH << 1))
#define N3600_SENSOR_PV_HEIGHT                       (N3600_IMAGE_SENSOR_HEIGHT)

#define N3600_SENSOR_VIDEO_WIDTH                  ((N3600_IMAGE_SENSOR_WIDTH << 1))
#define N3600_SENSOR_VIDEO_HEIGHT                 (N3600_IMAGE_SENSOR_HEIGHT)


#define N3600_WRITE_ID						(0x90)     // 8bit i2c write addr
#define N3600_READ_ID						(0x91)     // 8bit i2c read addr

#define HSM_MIPI_1_LANE				1
#define HSM_MIPI_2_LANE				2

//#define HSM_SENSOR_ID    (0x000a)  
...
typedef struct
{
	...
	kal_uint32 (*GetInfo)(enum MSDK_SCENARIO_ID_ENUM ScenarioId,MSDK_SENSOR_INFO_STRUCT *pSensorInfo,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);

	kal_uint32 (*Control)(enum MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);	  
