...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC8034SUBMIPI_SENSOR_ID,
...
#if GC8034SUB_MIRROR_FLIP_ENABLE
...
static struct gc8034sub_otp_t gc8034sub_otp_info;
...
static void gc8034sub_read_otp_kgroup(kal_uint8 page, kal_uint8 addr, kal_uint8 *buff, int size)
{
	kal_uint16 i;
...
static void gc8034sub_gcore_read_otp_info(void)
{
...
#endif
#if GC8034SUBOTP_DEBUG
	kal_uint8  debug[128] = { 0 };
#endif
	memset(&gc8034sub_otp_info, 0, sizeof(struct gc8034sub_otp_t));
	...
	case 0x01:
		LOG_INF("DD is valid!\n");
		total_number = gc8034sub_read_otp(0, 0x0c) + gc8034sub_read_otp(0, 0x0d);
		gc8034sub_otp_info.dd_flag = 0x01;
		gc8034sub_read_otp_kgroup(0, 0x0e, &ddtempbuff[0], 4 * total_number);
		for (i = 0; i < total_number; i++) {
			if ((ddtempbuff[4 * i + 3] & 0x80) == 0x80) {
				if ((ddtempbuff[4 * i + 3] & 0x03) == 0x03) {
					gc8034sub_otp_info.dd_param[cnt].x =
						(((kal_uint16)ddtempbuff[4 * i + 1] & 0x0f) << 8) + ddtempbuff[4 * i];
					gc8034sub_otp_info.dd_param[cnt].y =
						((kal_uint16)ddtempbuff[4 * i + 2] << 4)
						+ ((ddtempbuff[4 * i + 1] & 0xf0) >> 4);
					gc8034sub_otp_info.dd_param[cnt++].t = 2;
					gc8034sub_otp_info.dd_param[cnt].x =
						(((kal_uint16)ddtempbuff[4 * i + 1] & 0x0f) << 8) + ddtempbuff[4 * i];
					gc8034sub_otp_info.dd_param[cnt].y =
						((kal_uint16)ddtempbuff[4 * i + 2] << 4)
					...
					gc8034sub_otp_info.dd_param[cnt].y =
						((kal_uint16)ddtempbuff[4 * i + 2] << 4)
						+ ((ddtempbuff[4 * i + 1] & 0xf0) >> 4);
					gc8034sub_otp_info.dd_param[cnt++].t = ddtempbuff[4 * i + 3] & 0x03;
				}
			}
		}
		gc8034sub_otp_info.dd_cnt = cnt;
	...
	gc8034sub_otp_info.lsc_flag = 0;
	for (index = 0; index < 2; index++) {
		switch ((flag_lsc << (2 * index)) & 0x0c) {
		case 0x00:
			LOG_INF("lsc group %d is empty!\n", index + 1);
			gc8034sub_otp_info.lsc_flag = gc8034sub_otp_info.lsc_flag | 0x00;
			break;
		case 0x04:
			LOG_INF("lsc group %d is valid!\n", index + 1);
			check = 0;
			if (index == 0) {
				gc8034sub_read_otp_kgroup(3, 0x44, &gc8034sub_otp_info.lsc_param[0], 396);
				lsc_checksum = gc8034sub_read_otp(6, 0x50);
			} else {
				gc8034sub_read_otp_kgroup(6, 0x51, &gc8034sub_otp_info.lsc_param[0], 396);
				lsc_checksum = gc8034sub_read_otp(9, 0x5d);
			}
			for (i = 0; i < 396; i++)
				check += gc8034sub_otp_info.lsc_param[i];
			if ((check % 255 + 1) == lsc_checksum)
				gc8034sub_otp_info.lsc_flag = gc8034sub_otp_info.lsc_flag | 0x01;
			else {
				gc8034sub_otp_info.lsc_flag = gc8034sub_otp_info.lsc_flag | 0x02;
...
static void gc8034sub_gcore_update_dd(void)
{
	...
	struct gc8034sub_dd_t dd_temp = {0, 0, 0};

	if (gc8034sub_otp_info.dd_flag == 0x01) {
		LOG_INF("auto load start!\n");
		for (i = 0; i < gc8034sub_otp_info.dd_cnt; i++) {
#if GC8034SUB_MIRROR_FLIP_ENABLE
			switch (gc8034sub_otp_info.dd_param[i].t) {
			case 0:
				gc8034sub_otp_info.dd_param[i].x = DD_WIDTH - gc8034sub_otp_info.dd_param[i].x + 1;
				break;
			case 1:
				gc8034sub_otp_info.dd_param[i].x = DD_WIDTH - gc8034sub_otp_info.dd_param[i].x - 1;
				break;
			default:
				gc8034sub_otp_info.dd_param[i].x = DD_WIDTH - gc8034sub_otp_info.dd_param[i].x;
				break;
			}
#endif
#if GC8034SUB_MIRROR_FLIP_ENABLE
			gc8034sub_otp_info.dd_param[i].y = DD_HEIGHT - gc8034sub_otp_info. dd_param[i].y + 1;
#endif
		}
		for (i = 0; i < gc8034sub_otp_info.dd_cnt - 1; i++) {
			for (j = i + 1; j < gc8034sub_otp_info.dd_cnt; j++) {
				if (gc8034sub_otp_info.dd_param[i].y * DD_WIDTH + gc8034sub_otp_info.dd_param[i].x
				 > gc8034sub_otp_info.dd_param[j].y * DD_WIDTH + gc8034sub_otp_info.dd_param[j].x) {
					dd_temp.x = gc8034sub_otp_info.dd_param[i].x;
					dd_temp.y = gc8034sub_otp_info.dd_param[i].y;
					dd_temp.t = gc8034sub_otp_info.dd_param[i].t;
					gc8034sub_otp_info.dd_param[i].x = gc8034sub_otp_info.dd_param[j].x;
					gc8034sub_otp_info.dd_param[i].y = gc8034sub_otp_info.dd_param[j].y;
					gc8034sub_otp_info.dd_param[i].t = gc8034sub_otp_info.dd_param[j].t;
					gc8034sub_otp_info.dd_param[j].x = dd_temp.x;
					gc8034sub_otp_info.dd_param[j].y = dd_temp.y;
					gc8034sub_otp_info.dd_param[j].t = dd_temp.t;
				}
			}
		}
		...
		for (i = 0; i < gc8034sub_otp_info.dd_cnt; i++) {
			temp_val0 = gc8034sub_otp_info.dd_param[i].x & 0x00ff;
			temp_val1 = ((gc8034sub_otp_info.dd_param[i].y & 0x000f) << 4)
				+ ((gc8034sub_otp_info.dd_param[i].x & 0x0f00)>>8);
			temp_val2 = (gc8034sub_otp_info.dd_param[i].y & 0x0ff0) >> 4;
			write_cmos_sensor(0xaa, i);
			write_cmos_sensor(0xac, temp_val0);
			write_cmos_sensor(0xac, temp_val1);
			write_cmos_sensor(0xac, temp_val2);
			write_cmos_sensor(0xac, gc8034sub_otp_info.dd_param[i].t);
...
static void gc8034sub_gcore_update_lsc(void)
{
	...
	if ((gc8034sub_otp_info.lsc_flag & 0x01) == 0x01) {
		write_cmos_sensor(0xfe, 0x01);
		...
		for (i = 0; i < 9; i++) {
			...
			for (j = 0; j < 11; j++) {
				...
				base = 4 * (11 * i + j);
#endif
				write_cmos_sensor(0xcc, gc8034sub_otp_info.lsc_param[base + 0]);
				write_cmos_sensor(0xcc, gc8034sub_otp_info.lsc_param[base + 1]);
				write_cmos_sensor(0xcc, gc8034sub_otp_info.lsc_param[base + 2]);
				write_cmos_sensor(0xcc, gc8034sub_otp_info.lsc_param[base + 3]);
		}
		}
...
#if 0
static void gc8034sub_otp_identify(void)
{
	...
	gc8034sub_read_otp_group(0, GC8034SUB_OTP_ID_DATA_OFFSET, &gc8034sub_otp_info.otp_id[0], GC8034SUB_OTP_ID_SIZE);
...
#endif
static void gc8034sub_otp_function(void)
{
	kal_uint8 i = 0, flag = 0;
	kal_uint8 otp_id[GC8034SUB_OTP_ID_SIZE];

	memset(&otp_id, 0, GC8034SUB_OTP_ID_SIZE);
	write_cmos_sensor(0xfc, 0x00);
	write_cmos_sensor(0xf7, 0x97);
	write_cmos_sensor(0xfc, 0x00);
	write_cmos_sensor(0xfc, 0x00);
	...
	write_cmos_sensor(0xf2, 0x01);
	write_cmos_sensor(0xf4, 0x88);
	gc8034sub_read_otp_group(0, GC8034SUB_OTP_ID_DATA_OFFSET, &otp_id[0], GC8034SUB_OTP_ID_SIZE);
	for (i = 0; i < GC8034SUB_OTP_ID_SIZE; i++)
		if (otp_id[i] != gc8034sub_otp_info.otp_id[i]) {
			flag = 1;
			break;
		}
	...
	if (flag == 1) {
		...
		memset(&gc8034sub_otp_info, 0, sizeof(gc8034sub_otp_info));
		for (i = 0; i < GC8034SUB_OTP_ID_SIZE; i++)
			gc8034sub_otp_info.otp_id[i] = otp_id[i];
		gc8034sub_gcore_read_otp_info();
	}
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensor_id = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 1;
	return sensor_id;
}
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC8034SUB_MIRROR);
	...
	write_cmos_sensor(0x92, GC8034SUB_FULL_STARTY);
	write_cmos_sensor(0x94, GC8034SUB_FULL_STARTX);
...
static void binning_setting(void)
{
	...
	/* Crop window */
	write_cmos_sensor(0x90, 0x01);
	write_cmos_sensor(0x92, GC8034SUB_BIN_STARTY);
	write_cmos_sensor(0x94, GC8034SUB_BIN_STARTX);
	write_cmos_sensor(0x95, 0x04);
	write_cmos_sensor(0x96, 0xc8);
	write_cmos_sensor(0x97, 0x06);
	write_cmos_sensor(0x98, 0x60);
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x94, 0xb0 + GC8034SUB_BIN_STARTX);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			printk("[gc8034sub_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc8034sub_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			pr_debug("[gc8034sub_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
