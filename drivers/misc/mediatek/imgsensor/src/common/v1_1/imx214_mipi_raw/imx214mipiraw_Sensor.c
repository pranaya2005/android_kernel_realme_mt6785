...
extern int read_imx214_eeprom_mtk_fmt(void);
#endif
#define PFX "imx214_camera_sensor"
#define LOG_1 LOG_INF("imx214,MIPI 2LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value =0xd1fd8ad,

	.pre = {
        .pclk = 320000000,  //320000000,            //record different mode's pclk
...
*/
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R, //R Gr
	.mclk = 24,//24
...
static struct imgsensor_struct imgsensor = {
	.mirror = IMAGE_NORMAL,				//mirrorflip information //IMAGE_NORMAL IMAGE_V_MIRROR IMAGE_H_MIRROR IMAGE_HV_MIRROR
