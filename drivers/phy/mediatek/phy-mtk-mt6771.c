...
/* Stoneoim:zhangweipeng on: Mon, 25 May 2020 18:34:29 +0800
 * modify for cts verify mtp host test fail
		instance->phy_tuning.u2_vrt_ref = 6;
		instance->phy_tuning.u2_term_ref = 6;
 */

		instance->phy_tuning.u2_vrt_ref = 4;
		instance->phy_tuning.u2_term_ref = 4;
// End of Stoneoim:zhangweipeng
