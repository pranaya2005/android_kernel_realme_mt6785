...
/* StoneOim:wuxiaotian on: Sat, 29 May 2021 10:50:38 +0800
 * TODO: replace this line with your comment
 */
    tpd_load_status = 1;
    printk("%s (line %d) tpd_load_status=%d\n", __func__,__LINE__,tpd_load_status);
...
/* StoneOim:wuxiaotian on: Sat, 29 May 2021 11:18:12 +0800
 * TODO: replace this line with your comment
  */
    if (0 == tpd_load_status) {
      NVT_ERR("add error touch panel spi driver.");
      goto err_driver;
    }
// End of StoneOim:wuxiaotian
