...
// compatible select
#define SF_COMPATIBLE_SEL           SF_COMPATIBLE_TRUSTKERNEL //SF_COMPATIBLE_NOF
// power mode select
#define SF_POWER_MODE_SEL           PWR_MODE_NOF //GPIO供电PWR_MODE_GPIO 主板常供电PWR_MODE_NOF
// debug log select
#define SF_LOG_ENABLE               1
//-----------------------------------------------------------------------------

/* Dts node. */
#define COMPATIBLE_SW_FP            "mediatek,sunwave_finger"
