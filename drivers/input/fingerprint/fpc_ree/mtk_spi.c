...
static int mtk6797_probe(struct platform_device *spidev)
{
...
static int mtk6797_remove(struct platform_device *spidev)
{
...
static int __init fpc_sensor_init(void)
{
	...
	return status;
    */
        return (platform_driver_register(&mtk6797_driver) != 0)? EINVAL : 0;
}
...
static void __exit fpc_sensor_exit(void)
{
	//spi_unregister_driver(&mtk6797_driver);
        platform_driver_unregister(&mtk6797_driver);
}
