#ifndef __AW87329_H__
#define __AW87329_H__

unsigned char aw87329_kspk_cfg_default[] = {
...
unsigned char aw87329_drcv_cfg_default[] = {
	/*0x00, 0x39,  CHIPID REG */
	0x01, 0x02,
	0x02, 0xAB,
	0x03, 0x06,
...
unsigned char aw87329_abrcv_cfg_default[] = {
	/*0x00, 0x39,  CHIPID REG */
	0x01, 0x02,
	0x02, 0xAF,
	0x03, 0x06,
...
#define aw87329_REG_DFT1        0x62
#define aw87329_REG_DFT2        0x63
#define aw87329_REG_ENCRY       0x64

#define aw87329_CHIP_DISABLE    0x0C

#define AW87329_CHIPID          0x39

#define REG_NONE_ACCESS         0
#define REG_RD_ACCESS           (1 << 0)
#define REG_WR_ACCESS           (1 << 1)
#define aw87329_REG_MAX         0xFF
...
const unsigned char aw87329_reg_access[aw87329_REG_MAX] = {
	...
	[aw87329_REG_DFT1] = REG_RD_ACCESS,
	[aw87329_REG_DFT2] = REG_RD_ACCESS,
	[aw87329_REG_ENCRY] = REG_RD_ACCESS,
};
...
extern unsigned char aw87329_audio_abrcv(void);
#endif
